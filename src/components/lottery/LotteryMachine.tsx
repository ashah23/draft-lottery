                    ...
                    <CardContent className="px-8 pb-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                            ...
                            <div className="lg:col-span-2 flex justify-center">
                                <div className="relative">
                                    {/* Dome Container */}
                                    <div className="w-80 h-80 rounded-full border-4 border-primary/20 bg-linear-to-b from-primary/10 to-transparent flex items-center justify-center relative overflow-hidden shadow-2xl">
                                        {/* Bouncing Balls */}
                                ...
                                <div className="space-y-3 max-h-96 overflow-y-auto">
                                    {currentPick > 0 ? (
                                        draftOrder.slice(0, currentPick).map((team, index) => (
                                            <motion.div
                                                key={team.id}
                                                className="flex items-center space-x-4 p-4 bg-linear-to-r from-primary/10 to-primary/5 rounded-xl border border-primary/20"
                        ...
                        {isDrawing && (
                            <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                            >
                                <div className="bg-linear-to-r from-primary/10 to-primary/5 rounded-2xl p-6 border border-primary/20">
